...
# cumsum confirmed vs. cumsum testing
analysis <- data_frame_analysis_complete$cumulated # Select between confirmed, recovered, deaths, cumulated
...
plot(
  ...
  main = paste(Country, "cumulative confirmed", sep = " "),
  bty="n"
)
scaled_area <- 100
